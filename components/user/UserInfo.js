        ...
        <div className="flex flex-col items-center py-8 text-center">
            {
                session?.user?.image ? (<Image
                    ...
                    alt="user img" />) : (<div className="relative max-h-[180px] max-w-[180px] rounded-full lg:mb-8 h-[100px] w-[100px] bg-orange-600 grid place-items-center text-4xl text-white uppercase">
